...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(hrrp.StatusOK, invoiceView)
}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("message: Order was found")
		...
		invoice.Created_at, _ = time.Parse(time.RFC3339, time.Now().Format(time.RFC339))
		invoice.updated_at, _ = time.Parse(time.RFC3339, time.Now().Format(time.RFC339))
